...
本文按仓库实际实现组织，可作为论文正文和答辩讲稿的技术底稿。学校格式、作者信息、参考文献规范需按实际要求编排；最新结果引用[本轮验收报告](../test/media-acceptance-2026-09-08.md)，[前轮报告](../test/acceptance-2026-09-07.md)保留历史记录。可朗读的[约8分钟讲稿](defense-script-8min.md)与[证据索引](evidence-index.md)按当前已验证状态编写，未验证项目不能改写为已完成实验。
